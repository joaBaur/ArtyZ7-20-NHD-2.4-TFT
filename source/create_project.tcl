...
#
# create_project.tcl: Tcl script for re-creating project 'NHD-2.4-TFT-ArtyZ7-20-HDMI-01'
#
# Generated by Vivado on Fri Jun 08 10:18:57 +0200 2018
...
set orig_proj_dir "[file normalize "$origin_dir/NHD-2.4-TFT-ArtyZ7-20-HDMI-01"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../Diligent_Vivado_IP"]" $obj
...
if { [get_files Driver_16bitParallel.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-2.4-TFT-ArtyZ7-20-HDMI-01/NHD-2.4-TFT-ArtyZ7-20-HDMI-01.srcs/sources_1/imports/NHD/Driver_16bitParallel.vhd
}
if { [get_files NHD_24_240320CF_Init.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-2.4-TFT-ArtyZ7-20-HDMI-01/NHD-2.4-TFT-ArtyZ7-20-HDMI-01.srcs/sources_1/imports/NHD/NHD_24_240320CF_Init.vhd
}
if { [get_files NHD_24_240320CF.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-2.4-TFT-ArtyZ7-20-HDMI-01/NHD-2.4-TFT-ArtyZ7-20-HDMI-01.srcs/sources_1/imports/NHD/NHD_24_240320CF.vhd
}
if { [get_files VideoProcessing.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Vivado2018_Projects/NHD-2.4-TFT-ArtyZ7-20-HDMI-01/NHD-2.4-TFT-ArtyZ7-20-HDMI-01.srcs/sources_1/imports/NHD/VideoProcessing.vhd
}
...
# NHD_24_240320CF, VideoProcessing
  ...
  connect_bd_net -net i_reset_1 [get_bd_ports i_reset] [get_bd_pins NHD_24_240320CF_0/i_reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins rgb2dvi_0/aRst]
