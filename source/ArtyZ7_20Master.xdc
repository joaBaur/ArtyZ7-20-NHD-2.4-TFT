...
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { i_resolution }]; #IO_L7N_T1_AD2N_35 Sch=SW0
set_property -dict { PACKAGE_PIN M19  IOSTANDARD LVCMOS33 } [get_ports { i_rgb_test }]; #IO_L7P_T1_AD2P_35 Sch=SW1
...
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { i_reset }]; #IO_L4P_T0_35 Sch=BTN0
...
#create_clock -period 13.468 -waveform {0 5} [get_ports { hdmi_rx_clk_p }]; #set
set_property -dict { PACKAGE_PIN W20   IOSTANDARD TMDS_33  } [get_ports { hdmi_rx_data_n[0] }]; #IO_L16N_T2_34 Sch=HDMI_RX_D0_N
set_property -dict { PACKAGE_PIN V20   IOSTANDARD TMDS_33  } [get_ports { hdmi_rx_data_p[0] }]; #IO_L16P_T2_34 Sch=HDMI_RX_D0_P
set_property -dict { PACKAGE_PIN U20   IOSTANDARD TMDS_33  } [get_ports { hdmi_rx_data_n[1] }]; #IO_L15N_T2_DQS_34 Sch=HDMI_RX_D1_N
set_property -dict { PACKAGE_PIN T20   IOSTANDARD TMDS_33  } [get_ports { hdmi_rx_data_p[1] }]; #IO_L15P_T2_DQS_34 Sch=HDMI_RX_D1_P
...
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { i2c_scl_o }]; #IO_L8P_T1_AD10P_35 Sch=HDMI_TX_SCL
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { i2c_sda_o }]; #IO_L8N_T1_AD10N_35 Sch=HDMI_TX_SDA
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { o_db[0] }]; #IO_L5P_T0_34 Sch=CK_IO0
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { o_db[1] }]; #IO_L2N_T0_34 Sch=CK_IO1
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { o_db[2] }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=CK_IO2
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { o_db[3] }]; #IO_L3N_T0_DQS_34 Sch=CK_IO3
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { o_db[4] }]; #IO_L10P_T1_34 Sch=CK_IO4
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { o_db[5] }]; #IO_L5N_T0_34 Sch=CK_IO5
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { o_db[6] }]; #IO_L19P_T3_34 Sch=CK_IO6
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { o_db[7] }]; #IO_L9N_T1_DQS_34 Sch=CK_IO7
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { o_rs }]; #IO_L21P_T3_DQS_34 Sch=CK_IO8
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { o_dc }]; #IO_L21N_T3_DQS_34 Sch=CK_IO9
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { o_wr }]; #IO_L9P_T1_DQS_34 Sch=CK_IO10
...
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { o_db[8] }]; #IO_L19N_T3_VREF_13 Sch=CK_IO26
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { o_db[9] }]; #IO_L6N_T0_VREF_13 Sch=CK_IO27
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { o_db[10] }]; #IO_L22P_T3_13 Sch=CK_IO28
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { o_db[11] }]; #IO_L11P_T1_SRCC_13 Sch=CK_IO29
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { o_db[12] }]; #IO_L11N_T1_SRCC_13 Sch=CK_IO30
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { o_db[13] }]; #IO_L17N_T2_13 Sch=CK_IO31
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { o_db[14] }]; #IO_L15P_T2_DQS_13 Sch=CK_IO32
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { o_db[15] }]; #IO_L21N_T3_DQS_13 Sch=CK_IO33
